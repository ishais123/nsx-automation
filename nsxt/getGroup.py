...
"""
 Example : 
  ...
  The script will create a securiy group named "custom-prod-ishaiApp-linux" with 3 tag crateria (prod, ishaiApp and linux)
"""
...
class NSX_CLIENT():
	...
	def add_security_group(self):
		...
		# REST API calls
		url = "https://{}/{}".format(self.nsx_manager, ADD_GROUP_URI) 	
		headers = {
		...
		for x in range(0,len(rAppFile)):
			...
			displayName = "custom-" + strEnv + "-" + strApp + "-" + strOs
